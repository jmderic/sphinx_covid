# J. Mark Deric note: This file is not my original work.  It is
# offered by Pierre Tardy under the MIT License.  It was sourced from
# git@github.com:tardyp/sphinx-jinja.git at commit id 2ad074a
# MIT License
